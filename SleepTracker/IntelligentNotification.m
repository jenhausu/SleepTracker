...
- (NSDate *)decideShouldGoToBedTime
{
    ...
    switch (shouldGoToSleepTime) {
        case 0: {  //平均起床時間
            NSInteger averageWakeUpTimeInSecond = [[[self.statistic wakeUpTimeInTheRecent:7] objectAtIndex:2] integerValue];
        ...
        case 1: {  //平均上床時間
            NSInteger averageGoToSleepTimeInSecond = [[[self.statistic goToBedTimeInTheRecent:7] objectAtIndex:2] integerValue];
...
- (void)setRemindUserToRecordWakeUpTime
{
    ...
    NSInteger averageWakeUpTimeInSecond = [[[[[Statistic alloc] init] wakeUpTimeInTheRecent:7] objectAtIndex:2] integerValue];
    if (averageWakeUpTimeInSecond) {
